...
public class Course {
    ...
    // Many courses can be taught by one coach.
    @ManyToOne(fetch = FetchType.LAZY)
    @JoinColumn(name = "coach_id", nullable = false)
    private Coach coach;

    // Many courses can be held in one room.
    @ManyToOne(fetch = FetchType.LAZY)
     ...
     * Business logic to ensure endTime > startTime should be handled
     * in your service layer before persisting.
     */
    ...
    // A set of simple strings for tags.
    // Stored in a separate table "course_tags".
